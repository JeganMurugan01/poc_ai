  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full ">
        <div className="px-3 py-3 lg:px-5 lg:pl-3 border-b border-gray-200 bg-gray-800">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end ">
              <button
                ...
                type="button"
                className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 text-gray-400 hover:bg-gray-700 focus:ring-gray-600"
              >
              ...
              <p className="flex md:me-24">
                <span
                  onClick={() => {
                    nav("/");
                  }}
                  className="self-center  ms-4 flex text-xl font-semibold sm:text-2xl whitespace-nowrap text-white cursor-pointer"
                >
                  <img src={HeaderLogo} className="w-36 " />
                  <label className="ms-2">AI poc </label>
                </span>
              </p>
            </div>
            <div className="flex items-center">
              <div className="flex items-center ms-3 text-white ">
                <button
                  ...
                  className="text-gray-900  border border-gray-300 focus:outline-none bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 bg-gray-800 text-white border-gray-600 bg-gray-700 hover:border-white focus:ring-gray-700"
                >
                  Quick Test
                </button>
                <label onClick={() => nav("/admin")}>Admin</label>
              </div>
            </div>
          </div>
        </div>
            ...
            <ul className="space-y-2 font-medium">
              <li>
                <p className="flex items-center p-2 text-gray-900 rounded-lg text-white">
                  ...
                  <FaPlus
                    className="ms-28 mt-2 cursor-pointer text-white"
      ...
      {Page && (
        <div className="sm:ml-64 mt-16 p-4 bg-gray-900">
          <Page setTagImages={setTagImages} tagImages={tagImages} />
        </div>
      )}
    </>
  );
